...
import mbm.init.Blocks.SlopeIce;
...
BlockMaker.BOOKSHELF_SLOPE = new MainSlope("bookshelf_slope", Blocks.BOOKSHELF.getDefaultState(), Material.WOOD, SoundType.WOOD, 1.5F, "axe", 0, 0F, 0F, 1);
BlockMaker.MOSSY_COBBLESTONE_SLOPE = new MainSlope("mossy_cobblestone_slope", Blocks.STONE.getDefaultState(), Material.ROCK, SoundType.STONE, 2.0F, "pickaxe", 0, 10.0F, 0F, 1);
BlockMaker.OBSIDIAN_SLOPE = new MainSlope("obsidian_slope", Blocks.OBSIDIAN.getDefaultState(), Material.ROCK, SoundType.STONE, 50.0F, "pickaxe", 2, 2000.0F, 0F, 1);
BlockMaker.ICE_SLOPE = new SlopeIce("ice_slope", Blocks.ICE.getDefaultState(), Material.ICE, SoundType.GLASS, 0.5F, "pickaxe", 0, 0.0F, 0F, 1).setLightOpacity(3);
BlockMaker.PACKED_ICE_SLOPE = new MainSlope("packed_ice_slope", Blocks.PACKED_ICE.getDefaultState(), Material.PACKED_ICE, SoundType.GLASS, 0.5F, "pickaxe", 0, 0.0F, 0F, 1);
BlockMaker.SNOW_SLOPE = new MainSlope("snow_slope", Blocks.SNOW.getDefaultState(), Material.SNOW, SoundType.SNOW, 0.2F, "shovel", 0, 0.0F, 0F, 1);
BlockMaker.CLAY_SLOPE = new MainSlope("clay_slope", Blocks.CLAY.getDefaultState(), Material.CLAY, SoundType.GROUND, 0.6F, "pickaxe", 0, 0.0F, 0F, 1);
BlockMaker.PUMPKIN_SLOPE = new MainSlope("pumpkin_slope", Blocks.PUMPKIN.getDefaultState(), Material.WOOD, SoundType.WOOD, 1.0F, "axe", 0, 0.0F, 0F, 1);
BlockMaker.LIT_PUMPKIN_SLOPE = new MainSlope("lit_pumpkin_slope", Blocks.LIT_PUMPKIN.getDefaultState(), Material.WOOD, SoundType.WOOD, 1.0F, "axe", 0, 0.0F, 1.0F, 1);
BlockMaker.NETHERRACK_SLOPE = new MainSlope("netherrack_slope", Blocks.NETHERRACK.getDefaultState(), Material.ROCK, SoundType.STONE, 0.4F, "pickaxe", 0, 0.0F, 0F, 1);
BlockMaker.SOUL_SAND_SLOPE = new MainSlope("soul_sand_slope", Blocks.SOUL_SAND.getDefaultState(), Material.SAND, SoundType.SAND, 0.5F, "pickaxe", 0, 0.0F, 0F, 1);
BlockMaker.GLOWSTONE_SLOPE = new MainSlope("glowstone_slope", Blocks.GLOWSTONE.getDefaultState(), Material.GLASS, SoundType.GLASS, 0.3F, "pickaxe", 0, 0.0F, 1.0F, 1);
//Stained Glass
/*BlockMaker.ANDESITE_SLOPE = new MainSlope("andesite_slope", Blocks.STONE.getDefaultState(), Material.ROCK, SoundType.STONE, 1.5F, "pickaxe", 0, 10.0F, 0F, 1);
BlockMaker.ANDESITE_SLOPE = new MainSlope("andesite_slope", Blocks.STONE.getDefaultState(), Material.ROCK, SoundType.STONE, 1.5F, "pickaxe", 0, 10.0F, 0F, 1);
BlockMaker.ANDESITE_SLOPE = new MainSlope("andesite_slope", Blocks.STONE.getDefaultState(), Material.ROCK, SoundType.STONE, 1.5F, "pickaxe", 0, 10.0F, 0F, 1);
