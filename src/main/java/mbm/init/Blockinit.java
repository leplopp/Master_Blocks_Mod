...
BlockMaker.PODZOL_SLOPE = new MainBlock("podzol_slope", Material.GROUND, SoundType.GROUND, 0.5F, "shovel", 0, 0.0F, 0F, 1);
BlockMaker.FULL_PODZOL = new MainSlope("full_podzol", Blocks.DIRT.getDefaultState(), Material.GROUND, SoundType.GROUND, 0.5F, "shovel", 0, 0.0F, 0F, 1);
